					...
					if(isset($_POST["save_product"]) && isset($_FILES["p_image"]) )
{
				...
				<?php
					...
					if($checking==0)
					{
					$check=mysqli_query($connect,"UPDATE admin SET admin_name='$name',admin_phone='$phone',admin_email='$email',admin_address='$address',admin_image='$new_img_name'  WHERE admin_id='$id'");
					}
