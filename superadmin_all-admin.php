			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">Admin Details</h4> <a href="superadmin_add-admin.php" class="btn btn-primary float-right veiwbutton">Add Admin</a> </div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						...
						?>
											<tr>
												...
												<td style="text-align:center;"><?php echo $row['admin_email'] ?></td>
												<td style="text-align:center;"><?php echo $row['admin_phone'] ?></td>
												<td style="text-align:center;"><?php echo $row['admin_address'] ?></td>
												<td style="text-align:center;"><?php echo $row['admin_position'] ?></td>
												<td style="text-align:center;"><?php echo $row['admin_status'] ?></td>
												<td>
