...
<head>
	<title>Add Product Colour</title>
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Add Product Colour</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
							...
							<div class="row formtype">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" placeholder="Enter product color" name="product_color" required> <span id="error" style="color:red;"></span></div>
