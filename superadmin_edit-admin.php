    ...
    <div class="content container-fluid">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="sel1" name="phone" value="<?php echo $row['admin_phone']; ?>" pattern="0.+" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="11" required>
		...
		<div class="col-md-4">
			<div class="form-group">
				<label>Email</label>
				<input type="email" class="form-control" id="sel1" name="email" value="<?php echo $row['admin_email']; ?>" readonly>
			</div>
		</div>
