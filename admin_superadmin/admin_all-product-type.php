			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">All Product Type</h4> <a href="admin_add-product-type.php" class="btn btn-primary float-right veiwbutton">Add Product Type</a> </div>
						</div>
					</div>
				</div>
				<div class="row">
								...
								<div class="table-responsive">
									...
									?>
											...
											<td style="text-align:center;"><?php echo $row['product_type_name'] ?></td>
												<td>
												<div class="actions"> <a href="admin_edit-product-type.php?edit&id=<?php echo $row['product_type_id']; ?>" class="btn btn-info">Edit</a> <a href="admin_all-product-type.php?delete&id=<?php echo $row['product_type_id']; ?>" class="btn btn-danger" onclick="return confirmation()">Delete</a> </div>
												</td>
											</tr>
									<?php
										}
										...
										{
											$pid=$_GET['id'];
											mysqli_query($connect,"DELETE from product_type WHERE product_type_id='$pid'");
										}
								?>
