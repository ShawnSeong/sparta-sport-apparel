						...
						<div class="card card-table">
							<div class="card-body booking_card">
								...
								?>		
												...
												<td>
													<div class="actions"> <a href="superadmin_edit-order.php?edit&id=<?php echo $row['order_id']; ?>" class="btn btn-info">Edit</a> <a href="superadmin_all-order.php?delete&id=<?php echo $row['order_id']; ?>" class="btn btn-danger" onclick="return confirmation()">Delete</a> </div>
												</td>
											</tr>
									<?php
										...
										if (isset($_GET['delete'])) 
											{
												$pid=$_GET['id'];
												mysqli_query($connect,"DELETE from customer_order WHERE order_id='$pid'");
