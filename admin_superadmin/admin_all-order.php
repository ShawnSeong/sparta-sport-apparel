								...
								?>
											<tr>
												...
												<td style="text-align:center;">
													<div class="actions"> <a href="admin_edit-order.php?edit&id=<?php echo $row['order_id']; ?>" class="btn btn-info">Edit</a> <a href="admin_all-order.php?delete&id=<?php echo $row['order_id']; ?>" class="btn btn-danger" onclick="return confirmation()">Delete</a> </div>
												</td>
											</tr>
								<?php
										}
