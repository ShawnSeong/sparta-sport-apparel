						...
						<form method="post">
							...
							<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" placeholder="Enter product type name" name="product_type"> <span id="error" style="color:red;" required><?php echo $error; ?></span></div>
								</div>
							</div>
