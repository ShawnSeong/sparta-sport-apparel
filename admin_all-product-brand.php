...
<body>
	<div class="main-wrapper">
		...
		<?php
			header("refresh:0.2; url=admin_lo gin.php");
			exit();
		}
?>							
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">All Product Brand</h4> <a href="admin_add-product-brand.php" class="btn btn-primary float-right veiwbutton">Add Product Brand</a> </div>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="card card-table">
							<div class="card-body booking_card">
								<div class="table-responsive">
									...
									?>
											<tr>
											<td style="text-align:center;"><?php echo $row['product_brand_id'] ?></td>
											<td style="text-align:center;"><?php echo $row['product_brand_name'] ?></td>
												<td>
												<div class="actions"> <a href="admin_edit-product-brand.php?edit&id=<?php echo $row['product_brand_id']; ?>" class="btn btn-info">Edit</a> <a href="admin_all-product-brand.php?delete&id=<?php echo $row['product_brand_id']; ?>" class="btn btn-danger" onclick="return confirmation()">Delete</a> </div>
												</td>
											</tr>
									<?php
										}
									...
									<script type="text/javascript">
												...
												{
													var choice;
													choice=confirm("The related product will also been deleted.\nDo you want to delete?");
													return choice;
												}
										</script>	
