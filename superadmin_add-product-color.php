...
?>		
<?php
	if(isset($_POST["save_product_color"]))
	{
		$checking=0;
		$check=0;
			...
			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Add Product Color</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<form method="post" autocomplete="off">
							...
							<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" placeholder="Enter product color" name="product_color" required> <span id="error" style="color:red;"><?php echo $error; ?></span></div>
										
								</div>
							</div>

				<input  type="submit" class="btn btn-primary buttonedit ml-2" name="save_product_color" value="Save">
