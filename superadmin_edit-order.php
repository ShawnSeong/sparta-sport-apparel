    ...
    <div class="content container-fluid">
		...
		<div class="row">
			...
			<?php
					if(isset($_GET["edit"]))
						{
							...
							JOIN customer_order ON cart.payment_status = customer_order.order_id 
							JOIN payment ON customer_order.payment_id = payment.payment_id WHERE order_id='$pid' AND cart.product_id='$product_id' ");
				...
				<form method="post" autocomplete="off">
					...
					<div class="row formtype">
						...
						<div class="form-group">
										...
										<input class="form-control" type="text" name="product_quantity" value="RM <?php echo $row["cart_subtotal"]; ?>" readonly></div>
						</div>
				...
				<a href="superadmin_all-order.php" class="btn btn-secondary">Back</a>
			</form>
			<?php
						}
